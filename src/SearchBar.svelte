...
<input id="myInput" type="text" name="myCountry" placeholder="Search a member of Congress"
bind:value={member}>
<button on:click={clearLabels}>
    Clear labels
</button>
</div>
...
<style>
    * { box-sizing: border-box; }
    ...
    :global(.autocomplete-items div) {
    padding: 10px;
    cursor: pointer;
    background-color: #fff;
    border-bottom: 1px solid #d4d4d4;
    }
    :global(.autocomplete-items div:hover) {
